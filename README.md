...
Instructions to Create Repo Publicly
On GitHub (or any public git hosting):

Create a new public repository named auto_driving_robot

Clone it locally

Commit the above files with proper filenames
...
bash
git clone https://github.com/<your-username>/auto_driving_robot.git
cd auto_driving_robot
pip install -r requirements.txt
python run_robot.py
